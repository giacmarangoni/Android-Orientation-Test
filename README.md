...
You will notice that orientation will turn automatically to landscape mode (even though landscape it's disable on smartphones thanks to  ```portrai_only``` property contained in bool.xml) and, after a while, It will come back to portrait mode.
